...
real(8):: alpha, beta, gamma, theta,theta1,theta2, phi, tau, lambda
...
open(19,file='Rc60.dat')
allocate(vrr(ncadeiasc60,1,ncadeiasc60,1))
allocate(  R(ncadeiasc60,1,ncadeiasc60,1))
R   = 0.0d0

do l=1,ncadeiasc60
  m=1
  o=1
  do n=l+1,ncadeiasc60
   ...
   write(19,'(2i5,1f12.5)')l,n, R(l,m,n,o)
   end if
  end do 
end do
close(19)
...
do l=1,ncadeiasc60
  ...
  do n = 1, ncadeiaspt
   ...
   vrr(l,m,n,o) = (/ xxm, yym, zzm /)
   R(l,m,n,o)= sqrt( vrr(l,m,n,o).DOT.vrr(l,m,n,o) )
   if (R(l,m,n,o) <= 20) then
   write(18,*) l,n,o,R(l,m,n,o)!,theta!,vrr(l,m,n,o)
   end if
...
open(22,file='Ang-p3ht+c60.dat')
do l=1,ncadeiasc60
      m=1
      do n = 1, ncadeiaspt
         do o = 1, naneisolig
	    if (R(l,m,n,o) <= 9.5) then

            anelanel = vrr(l,m,n,o)/R(l,m,n,o)
            dotp1 = anelanel.DOT.v_normal(n,o)
            theta= dacos( dotp1*0.9999999d0 )*(180.d0/PI)
            write(22,*) l,n,o,R(l,m,n,o),theta!,vrr(l,m,n,o)
            end if
         end do
      end do
end do
