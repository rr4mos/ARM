...
open(22,file='inter.pbc-p3ht.dat')
do l=1,ncadeias-1
   do m = 1, naneisolig
      do n = l+1, ncadeias
         do o = 1, naneisolig
	    if (R(l,m,n,o) < limR) then
            ...
            dotp = anelanel.DOT.v_normal(n,o)*0.999999d0
            dotp1= v_normal(l,m).DOT.v_normal(n,o)
            write(22,*) R(l,m,n,o),dacos(dotp)*180/PI,dacos(dotp1)*180/PI
            end if
         end do
      end do
   end do
...
print *, 'ARM-INTER-P3HT: concluido!'
print *, ''
